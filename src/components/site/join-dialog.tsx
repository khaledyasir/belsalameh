    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto p-4 sm:p-6">
      ...
      >
        <button
          ...
          onClick={onClose}
          aria-label="Close"
          className="absolute end-3.5 top-3.5 grid h-9 w-9 place-items-center rounded-full text-ink-muted transition hover:bg-surface-muted hover:text-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
        >
          <X className="h-5 w-5" aria-hidden />
        </button>

        <h2 id={titleId} className="font-display text-heading-1 font-bold text-ink">
