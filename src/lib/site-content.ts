...
export const SITE = {
  ...
  faq: {
    ...
    categories: ["About Belsalameh", "Membership", "Using the service", "Airline eligibility", "Baggage", "Payments", "Support"] as const,
    items: [
      {
        category: "About Belsalameh",
