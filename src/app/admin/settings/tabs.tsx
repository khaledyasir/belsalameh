...
const TABS = [
  ...
  { href: "/admin/settings/launch-readiness", label: "Launch readiness" },
];

export function SettingsTabs() {
  const pathname = usePathname();
  return (
    <nav className="mb-5 flex flex-wrap gap-1 border-b border-border" aria-label="Settings sections">
      {TABS.map((t) => {
